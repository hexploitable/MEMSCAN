...
#include <mach/vm_region.h>
     ...
     extern kern_return_t mach_vm_region(vm_map_t, new_vm_address_t *, mach_vm_size_t *, vm_region_flavor_t, vm_region_info_t, mach_msg_type_number_t *, mach_port_t *);
